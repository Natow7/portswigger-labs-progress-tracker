...
![Total Labs](https://img.shields.io/badge/Total%20Labs%20Solved-101-blue) ![Last Updated](https://img.shields.io/badge/Last%20Updated-2026--09--13-yellow) ![Level](https://img.shields.io/badge/Level-NEWBIE-green) ![Vulnerability labs](https://img.shields.io/badge/Completed-26.2%25-purple)
...
- **cross-site scripting**: 10/30 lab
- **API testing**: 4/5 lab
...
- **HTTP request smuggling**: 12/22 lab
...
| 85 | 2026-09-13 | HTTP request smuggling | HTTP request smuggling, basic CL.TE vulnerability | Practitioner | N/A |
| 86 | 2026-09-13 | HTTP request smuggling | HTTP request smuggling, basic TE.CL vulnerability | Practitioner | N/A |
...
| 93 | 2026-09-13 | HTTP request smuggling | Exploiting HTTP request smuggling to capture other users' requests | Practitioner | N/A |
| 94 | 2026-09-13 | HTTP request smuggling | Exploiting HTTP request smuggling to deliver reflected XSS | Practitioner | N/A |
| 95 | 2026-09-13 | HTTP request smuggling | Response queue poisoning via H2.TE request smuggling | Practitioner | N/A |
| 96 | 2026-09-13 | HTTP request smuggling | H2.CL request smuggling | Practitioner | N/A |
